...
<html>
  ...
  <body>
    ...
    <form action="" method="POST">
      ...
      <input type="text" name="username" class="form-control" size="35" /><br><br>
    
      <p>Please enter a temporary password:</p>
      <input type="text" name="password" class="form-control" size="35"/><br><br>
      ...
      <input type="submit" onClick="addUser(this.form);" value="Submit"/>
    </form>
  </body>
</html>